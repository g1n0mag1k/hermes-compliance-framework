  ...
  return (
    <section id="audit-chain" data-section="audit-chain" className="px-6 sm:px-8 lg:px-10 py-section">
      <div className="w-full max-w-content mx-auto">
        ...
        <p className="font-mono text-caption text-muted mt-2">Illustrative output — not live product data. CFR citations shown are sample format; Hermes currently covers 18 of 18 Safe Harbor identifier categories.</p>
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            <p className="font-mono text-caption text-verify mt-3">✓ Core identifiers redacted — name, DOB, SSN, phone numbers (illustrative sample)</p>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col">
          <div className="bg-surface border-2 border-signal">
            <div className="flex items-center justify-between border-b-2 border-border px-4 py-3">
              ...
              <span className="font-mono text-caption text-signal">5 blocks</span>
            </div>
