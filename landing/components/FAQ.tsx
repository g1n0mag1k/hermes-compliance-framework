...
const FAQS: readonly FAQItem[] = [
  {
    ...
    answer:
      "No automated PHI redaction system achieves perfect recall, and Hermes does not claim certified Safe Harbor de-identification or blanket HIPAA compliance. Hermes currently detects 13 of 18 HIPAA Safe Harbor identifier categories: person names, dates, organizations, phone numbers, fax numbers, email addresses, URLs, IP addresses, physical addresses/locations, Social Security numbers, medical record numbers, health plan beneficiary numbers, account numbers, vehicle identifiers (VINs), and payment card numbers (Luhn-validated). The remaining 5 categories — certificate/license numbers, device identifiers, biometric identifiers, full-face photos, and catch-all unique identifiers — are not yet covered. Treat Hermes as a strong first layer for PHI reduction, not a substitute for your risk assessment or human review on high-stakes payloads. The cryptographically signed attestation receipt records exactly which categories were flagged and redacted for a given transaction — tamper-evident proof of what happened, not a vague compliance claim.",
  },
  {
    question: "What is a hash-chained attestation receipt and why does it matter?",
    answer:
